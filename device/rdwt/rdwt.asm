...
sdc3
   move.l   d0,d1
   cmp.l    #$20000,d0              ;no more than 256*512B at once now :-(
   blt      sdc5                    ;maybe will be fixed later
...
pa2
   ...
   WATAWORD (a1)+,TF_DATA
pa3
   move.l   #LOOP3-1,d2                  ;wait to packet execution result
pa4
   ;subq.l   #1,d2
   dbeq     d2,pretec
   bsr      pause
