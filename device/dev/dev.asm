;Lastest modification November 2005
   ...
   include "MYDEVI:"       ;select name etc, of the device

   include "/lib/myscsi.i" ;

   include "/lib/ata.i"    ;ATA commands and other ATA codes

   include "INTERFACEI:"   ;This include has the macros which
...
;32bits ;Address     ;number of command; and its bit mask
   ...
   DC.L  RdWt        ;2 $00000004    Common routine for read/write

   DC.L  RdWt        ;3 $00000008
